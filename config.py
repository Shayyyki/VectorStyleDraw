...
def parse_arguments():
    ...
    parser.add_argument("--svg", help="source SVG path", default="inputs/svg/T-shirt1.svg")
    parser.add_argument("--image_path", type=str,
                        default="inputs/start1024.png")
    ...
    parser.add_argument("--use_normalized_clip", type=bool, default=False)
    ...
    parser.add_argument("--num_paths", type=int,
                        default=256, help="number of strokes")
